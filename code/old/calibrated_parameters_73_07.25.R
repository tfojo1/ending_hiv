...
parameters.prior = join.distributions(
    ...
    age1.msm.susceptibility.rr1 = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(TRATE.RR.0.PEAK.SPAN)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    age.1.suppression = c('age1.suppressed.or',
                          'age1.suppressed.slope.or'),
    
    age.2.suppression = c('age2.suppressed.or',
                          'age2.suppressed.slope.or'),
    
    age.4.suppressoin = c('age4.suppressed.or',
                          'age4.suppressed.slope.or'),
    
    age.5.suppression = c('age5.suppressed.or',
