#v112 - like v110 with with female.vs.male for het and IDU time varying
...
parameters.prior = join.distributions(
    ...
    male.vs.female.heterosexual.rr.peak = Lognormal.Distribution(log(3.75/4.75 * 87.4/92), 0.5*log(2)),
    male.vs.female.heterosexual.rr.0 = Lognormal.Distribution(log(3.75/4.75 * 87.4/92), 0.5*log(2)),
    male.vs.female.heterosexual.rr.1 = Lognormal.Distribution(log(3.75/4.75 * 87.4/92), 0.5*log(2)),
    male.vs.female.heterosexual.rr.2 = Lognormal.Distribution(log(3.75/4.75 * 87.4/92), 0.5*log(2)),
    ...
    female.vs.heterosexual.male.idu.susceptibility.rr.peak = Lognormal.Distribution(log(.777/.755*.364/.309), 0.5*log(2)),
    female.vs.heterosexual.male.idu.susceptibility.rr.0 = Lognormal.Distribution(log(.777/.755*.364/.309), 0.5*log(2)),
    female.vs.heterosexual.male.idu.susceptibility.rr.1 = Lognormal.Distribution(log(.777/.755*.364/.309), 0.5*log(2)),
    female.vs.heterosexual.male.idu.susceptibility.rr.2 = Lognormal.Distribution(log(.777/.755*.364/.309), 0.5*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    msm.age.susceptibility = c('age1.msm.susceptibility.rr.mult.1',
...
#aging.1 rates from 2010 data in table 15a of
# https://www.cdc.gov/hiv/pdf/library/reports/surveillance/cdc-hiv-surveillance-report-2011-vol-23.pdf
AGE2.AGING.1 = get.aging.rate.last.of.10(49965,69515)
AGE3.AGING.1 = get.aging.rate.last.of.10(91431,140082)
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    heterosexual.male.age.rr.peak = heterosexual.female.age.rr.peak * parameters['male.vs.female.heterosexual.rr.peak']
    heterosexual.male.age.rr0 = heterosexual.female.age.rr0 * parameters['male.vs.female.heterosexual.rr.0']
    heterosexual.male.age.rr1 = heterosexual.female.age.rr1 * parameters['male.vs.female.heterosexual.rr.1']
    heterosexual.male.age.rr2 = heterosexual.female.age.rr2 * parameters['male.vs.female.heterosexual.rr.2']
    ...
    # IDU - female
    idu.female.age.rr.peak = idu.male.age.rr.peak * parameters['female.vs.heterosexual.male.idu.susceptibility.rr.peak']
    idu.female.age.rr0 = idu.male.age.rr0 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr.0']
    idu.female.age.rr1 = idu.male.age.rr1 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr.1']
    idu.female.age.rr2 = idu.male.age.rr2 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr.2']
