...
parameters.prior = join.distributions(
    ...
    age1.susceptibility.rr = Compound.Symmetry.Multivariate.Normal.Distribution(rho=0.7, n=2,
                                                                                mu=log(0.6*78.50/mean(c(77.84,63.22))),
                                                                                sds=0.25*log(2),
                                                                                transformations = 'log',
                                                                                lower=0, upper=Inf,
                                                                                var.names = paste0('age1.susceptibility.rr',1:2)),
    age2.susceptibility.rr = Compound.Symmetry.Multivariate.Normal.Distribution(rho=0.7, n=2,
                                                                                mu=log(mean(c(78.50,77.84))/mean(c(77.84,63.22))),
                                                                                sds=0.25*log(2),
                                                                                transformations = 'log',
                                                                                lower=0, upper=Inf,
                                                                                var.names = paste0('age2.susceptibility.rr',1:2)),
    age4.susceptibility.rr = Compound.Symmetry.Multivariate.Normal.Distribution(rho=0.7, n=2,
                                                                                mu=log(mean(c(63.22,38.29))/mean(c(77.84,63.22))),
                                                                                sds=0.25*log(2),
                                                                                transformations = 'log',
                                                                                lower=0, upper=Inf,
                                                                                var.names = paste0('age4.susceptibility.rr',1:2)),
    age5.susceptibility.rr = Compound.Symmetry.Multivariate.Normal.Distribution(rho=0.7, n=2,
                                                                                mu=log(mean(c(38.29,25.03,10.88))/mean(c(77.84,63.22))),
                                                                                sds=0.25*log(2),
                                                                                transformations = 'log',
                                                                                lower=0, upper=Inf,
                                                                                var.names = paste0('age5.susceptibility.rr',1:2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    age.12.susceptibility = c('age1.susceptibility.rr1',
                              'age1.susceptibility.rr2',
                              'age2.susceptibility.rr1',
                              'age2.susceptibility.rr2'),

    age.45.susceptibility = c('age4.susceptibility.rr1',
                              'age4.susceptibility.rr2',
                              'age5.susceptibility.rr1',
                              'age5.susceptibility.rr2'),
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    msm.age.rr.peak = heterosexual.age.rr.peak = idu.age.rr.peak = c(parameters['age1.susceptibility.rr1'],
                                                                     parameters['age2.susceptibility.rr1'],
                                                                     1,#parameters['age3.susceptibility.rr.peak'],
                                                                     parameters['age4.susceptibility.rr1'],
                                                                     parameters['age5.susceptibility.rr1'])

    heterosexual.age.rr0 = idu.age.rr0 = c(parameters['age1.susceptibility.rr1'],
                                           parameters['age2.susceptibility.rr1'],
                                           1,#parameters['age3.susceptibility.rr0'],
                                           parameters['age4.susceptibility.rr1'],
                                           parameters['age5.susceptibility.rr1'])

    msm.age.rr0 = c(parameters['age1.susceptibility.rr1'],
                    parameters['age2.susceptibility.rr1'],
                    1,#parameters['age3.susceptibility.rr0'],
                    parameters['age4.susceptibility.rr1'],
                    parameters['age5.susceptibility.rr1'])
    ...
    msm.age.rr2 = c(parameters['age1.msm.susceptibility.rr2'],
                    ...
                    1,#parameters['age3.susceptibility.rr1'],
                    parameters['age4.susceptibility.rr2'],
                    parameters['age5.susceptibility.rr2'])

    heterosexual.age.rr1 = idu.age.rr1 = c(parameters['age1.susceptibility.rr1'],
                                           parameters['age2.susceptibility.rr1'],
                                           1,#parameters['age3.susceptibility.rr1'],
                                           parameters['age4.susceptibility.rr1'],
                                           parameters['age5.susceptibility.rr1'])

    heterosexual.age.rr2 = idu.age.rr2 = c(parameters['age1.susceptibility.rr2'],
                                           parameters['age2.susceptibility.rr2'],
                                           1,#parameters['age3.susceptibility.rr1'],
                                           parameters['age4.susceptibility.rr2'],
                                           parameters['age5.susceptibility.rr2'])
