...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    early.msm.transmission = c('black.msm.trate.0',
                               'hispanic.msm.trate.0',
                               'other.msm.trate.0',
                               'msm.peak.trate.multiplier'),
    ...
    early.heterosexual.transmission = c('black.heterosexual.trate.0',
    ...
    early.idu.transmission = c('black.idu.trate.0',
