...
parameters.prior = join.distributions(
    ...
    black.prep.or = Lognormal.Distribution(0, log(1.5)/2),
    hispanic.prep.or = Lognormal.Distribution(0, log(1.5)/2),
    
    age1.prep.or = Lognormal.Distribution(0, log(4)),
    age2.prep.or = Lognormal.Distribution(0, log(4)),
    age4.prep.or = Lognormal.Distribution(0, log(4)),
    age5.prep.or = Lognormal.Distribution(0, log(4)),
