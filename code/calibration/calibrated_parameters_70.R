...
TRATE.RR.0.1.SPAN = 4#1.5
TRATE.RR.0.PEAK.SPAN = 4
...
parameters.prior = join.distributions(
    ...
    total.suppressed.slope.or = Lognormal.Distribution(0, log(1.05)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    suppression.by.age = c('age1.suppressed.or',
                           'age2.suppressed.or',
                           'age4.suppressed.or',
                           'age5.suppressed.or'),
    
    total.suppression.slope = 'total.suppressed.slope.or',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    components = set.background.suppression.ors(components,
                                                ...
                                                total.or.slope=parameters['total.suppressed.slope.or'])
