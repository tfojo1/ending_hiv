                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    components = set.background.hiv.testing.proportions(components,
                                                        ...
                                                        testing.ramp.up.yearly.increase = components$background.testing.inputs$testing.ramp.up.yearly.increase,
                                                        testing.ramp.up.year = components$background.testing.inputs$testing.ramp.up.year,
