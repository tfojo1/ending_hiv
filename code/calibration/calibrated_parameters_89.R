...
parameters.prior = join.distributions(
    ...
    heterosexual.male.age1.aging.base = Lognormal.Distribution(log((427+1861)/2/(814+3752)), 0.25*log(2)),
    heterosexual.male.age2.aging.0 = Lognormal.Distribution(log(get.aging.rate.mid.of.20(56552,151476)), 0.5*log(2)),
    heterosexual.male.age2.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(49965,69515)), 0.5*log(2)),
    #heterosexual.male.age2.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(11562,16831), 0.5*log(2)),
    heterosexual.male.age3.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(91431,140082)), 0.5*log(2)),
    #heterosexual.male.age3.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(23488,28704)), 0.5*log(2)),
    heterosexual.male.age4.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(173559,139643)), 0.5*log(2)),
    #heterosexual.male.age4.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(34401,38437)), 0.5*log(2)),
    
    heterosexual.female.age1.aging.base = Lognormal.Distribution(log((427+1861)/2/(814+3752)), 0.25*log(2)),
    heterosexual.female.age2.aging.0 = Lognormal.Distribution(log(get.aging.rate.mid.of.20(56552,151476)), 0.5*log(2)),
    heterosexual.female.age2.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(49965,69515)), 0.5*log(2)),
    #heterosexual.female.age2.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(11562,16831), 0.5*log(2)),
    heterosexual.female.age3.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(91431,140082)), 0.5*log(2)),
    #heterosexual.female.age3.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(23488,28704)), 0.5*log(2)),
    heterosexual.female.age4.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(173559,139643)), 0.5*log(2)),
    #heterosexual.female.age4.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(34401,38437)), 0.5*log(2)),
    ...
    male.vs.female.heterosexual.rr.peak = Lognormal.Distribution(0, 0.5*log(2)),
    male.vs.female.heterosexual.rr0 = Lognormal.Distribution(0, 0.5*log(2)),
    male.vs.female.heterosexual.rr1 = Lognormal.Distribution(0, 0.5*log(2)),
    male.vs.female.heterosexual.rr2 = Lognormal.Distribution(0, 0.5*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    pairings.with.msm = c('oe.female.pairings.with.msm',
    ...
    heterosexual.transmission.peak = c('black.heterosexual.trate.peak',
                                       ...
                                       'male.vs.female.heterosexual.rr.peak'),
    
    heterosexual.transmission.0 = c('black.heterosexual.trate.0',
                                    'hispanic.heterosexual.trate.0',
                                    'other.heterosexual.trate.0',
                                    'male.vs.female.heterosexual.rr0'),
    
    heterosexual.transmission.1 = c('black.heterosexual.trate.1',
                                    'hispanic.heterosexual.trate.1',
                                    'other.heterosexual.trate.1',
                                    'male.vs.female.heterosexual.rr1'),
    
    heterosexual.transmission.2 = c('black.heterosexual.trate.2',
                                    'hispanic.heterosexual.trate.2',
                                    'other.heterosexual.trate.2',
                                    'male.vs.female.heterosexual.rr2'),
    
    heterosexual.male.aging = c('heterosexual.male.age1.aging.base',
                                'heterosexual.male.age2.aging.0',
                                'heterosexual.male.age2.aging.1',
                                'heterosexual.male.age3.aging.1',
                                'heterosexual.male.age4.aging.1'),
    
    heterosexual.female.aging = c('heterosexual.female.age1.aging.base',
                                  'heterosexual.female.age2.aging.0',
                                  'heterosexual.female.age2.aging.1',
                                  'heterosexual.female.age3.aging.1',
                                  'heterosexual.female.age4.aging.1'),
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    msm.age.rr2 = c(parameters['age1.msm.susceptibility.rr2'],
                    ...
                    parameters['age5.susceptibility.rr'])
    # Het male
    heterosexual.male.age.rr.peak = 
        c(parameters['age1.susceptibility.rr'],
          parameters['age2.susceptibility.rr'],
          1,
          parameters['age4.susceptibility.rr'],
          parameters['age5.susceptibility.rr']) * parameters['male.vs.female.heterosexual.rr.peak']
    heterosexual.male.age.rr0 =
        c(parameters['age1.susceptibility.rr'],
          parameters['age2.susceptibility.rr'],
          1,
          parameters['age4.susceptibility.rr'],
          parameters['age5.susceptibility.rr']) * parameters['male.vs.female.heterosexual.rr0']
    heterosexual.male.age.rr1 =
        c(parameters['age1.susceptibility.rr'],
          parameters['age2.susceptibility.rr'],
          1,
          parameters['age4.susceptibility.rr'],
          parameters['age5.susceptibility.rr']) * parameters['male.vs.female.heterosexual.rr1']
    heterosexual.male.age.rr2 = 
        c(parameters['age1.susceptibility.rr'],
          parameters['age2.susceptibility.rr'],
          1,
          parameters['age4.susceptibility.rr'],
          parameters['age5.susceptibility.rr']) * parameters['male.vs.female.heterosexual.rr2']
