...
parameters.prior = join.distributions(
    ...
    global.trate.msm = Loguniform.Distribution(0,Inf),
    global.trate.heterosexual = Loguniform.Distribution(0,Inf),
    global.trate.idu = Loguniform.Distribution(0,Inf),
    ...
    msm.age1.aging.base = Lognormal.Distribution(log(2*0.16), 0.5*log(2)),
    ...
    heterosexual.age1.aging.base = Lognormal.Distribution(log(0.16), 0.5*log(2)),
    ...
    idu.age1.aging.base = Lognormal.Distribution(log(0.16), 0.5*log(2)),
    ...
    #-- HIV Testing --#
    heterosexual.proportion.tested.or = Lognormal.Distribution(log(0.25), 0.5*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    global.trates = c('global.trate.msm',
                      'global.trate.heterosexual',
                      'global.trate.idu'),
    ...
    black.sexual.mixing = 'black.black.sexual.oe',
    
    hispanic.other.sexual.mixing = c('hispanic.hispanic.sexual.oe',
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='msm', races=race,
                                      ...
                                      r0 = parameters[paste0(race, '.msm.trate.0')] * msm.age.rr0[age.index] * parameters['global.trate.msm'],
                                      r1 = parameters[paste0(race, '.msm.trate.1')] * msm.age.rr1[age.index] * parameters['global.trate.msm'],
                                      r2 = parameters[paste0(race, '.msm.trate.2')] * msm.age.rr2[age.index] * parameters['global.trate.msm'],
                                      r.peak = parameters[paste0(race, '.msm.trate.peak')] * msm.age.rr.peak[age.index] * parameters['global.trate.msm'],
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='heterosexual', races=race,
                                      age.indices = age.index,
                                      r0 = parameters[paste0(race, '.heterosexual.trate.0')] * heterosexual.age.rr0[age.index] * parameters['global.trate.heterosexual'],
                                      r1 = parameters[paste0(race, '.heterosexual.trate.1')] * heterosexual.age.rr1[age.index] * parameters['global.trate.heterosexual'],
                                      r2 = parameters[paste0(race, '.heterosexual.trate.2')] * heterosexual.age.rr2[age.index] * parameters['global.trate.heterosexual'],
                                      r.peak = parameters[paste0(race, '.heterosexual.trate.peak')] * heterosexual.age.rr.peak[age.index] * parameters['global.trate.heterosexual'],
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='idu', races=race,
                                      age.indices = age.index,
                                      r0 = parameters[paste0(race, '.idu.trate.0')] * idu.age.rr0[age.index] * parameters['global.trate.idu'],
                                      r1 = parameters[paste0(race, '.idu.trate.1')] * idu.age.rr1[age.index] * parameters['global.trate.idu'],
                                      r2 = parameters[paste0(race, '.idu.trate.2')] * idu.age.rr2[age.index] * parameters['global.trate.idu'],
                                      r.peak = parameters[paste0(race, '.idu.trate.peak')] * idu.age.rr.peak[age.index] * parameters['global.trate.idu'],
