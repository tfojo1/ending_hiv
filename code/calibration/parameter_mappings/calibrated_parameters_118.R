...
parameters.prior = join.distributions(
    ...
    #-- MSM Transmission --#
    black.msm.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(MSM.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
            0.5 * log(TRATE.RR.1.2.SPAN),
        rr.0.to.1.log.sd =
            0.5 * log(TRATE.RR.0.1.SPAN),
        race =
            'black',
        route =
            'msm'
    ...
    hispanic.msm.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(MSM.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    other.msm.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(MSM.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    msm.peak.trate.multiplier =  Lognormal.Distribution(log(3.1), 0.5 *
                                                            log(TRATE.RR.0.PEAK.SPAN)),
    
    
    #-- Heterosexual Transmission --#
    black.heterosexual.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(HET.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
            0.5 * log(TRATE.RR.1.2.SPAN),
    ...
    hispanic.heterosexual.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(HET.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    other.heterosexual.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(HET.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    heterosexual.peak.trate.multiplier =  Lognormal.Distribution(log(2.2), 0.5 *
                                                                     log(TRATE.RR.0.PEAK.SPAN)),
    
    
    #-- IDU Transmission --#
    black.idu.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(IDU.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
            0.5 * log(TRATE.RR.1.2.SPAN),
    ...
    hispanic.idu.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(IDU.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    other.idu.transmission = create.transmission.prior.distribution(
        r1.log.mean = log(IDU.BASE.TRATE.MEAN),
        r1.log.sd =
            log(BASE.TRATE.CV),
        rr.2.to.1.log.sd =
    ...
    idu.peak.trate.multiplier =  Lognormal.Distribution(log(4.7), 0.5 *
                                                            log(TRATE.RR.0.PEAK.SPAN)),
    ...
    # as an RR
    msm.vs.heterosexual.male.idu.susceptibility.rr.peak = Lognormal.Distribution(log(3.3), 0.5 *
                                                                                     log(2)),
    msm.vs.heterosexual.male.idu.susceptibility.rr.0 = Lognormal.Distribution(log(3.3), 0.5 *
                                                                                  log(2)),
    msm.vs.heterosexual.male.idu.susceptibility.rr.1 = Lognormal.Distribution(log(3.3), 0.5 *
                                                                                  log(2)),
    msm.vs.heterosexual.male.idu.susceptibility.rr.2 = Lognormal.Distribution(log(3.3), 0.5 *
                                                                                  log(2)),
    ...
    age1.msm.susceptibility.rr.mult.1 = Lognormal.Distribution(0, 0.25 *
                                                                   log(2)),
    age2.msm.susceptibility.rr.mult.1 = Lognormal.Distribution(0, 0.25 *
                                                                   log(2)),
    age4.msm.susceptibility.rr.mult.12 = Lognormal.Distribution(0, 0.25 *
                                                                    log(2)),
    age5.msm.susceptibility.rr.mult.12 = Lognormal.Distribution(0, 0.25 *
                                                                    log(2)),
    
    age1.msm.susceptibility.rr.mult.2 = Lognormal.Distribution(0, 0.25 *
                                                                   log(2)),
    age2.msm.susceptibility.rr.mult.2 = Lognormal.Distribution(0, 0.25 *
                                                                   log(2)),
    ...
    msm.age1.aging.base = Lognormal.Distribution(log(12209 / 2 / 22537), 0.25 *
                                                     log(2)),
    msm.age2.aging.0 = Lognormal.Distribution(log(get.aging.rate.mid.of.20(56552, 151476)), 0.5 *
                                                  log(2)),
    msm.age2.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(49965, 69515)), 0.5 *
                                                  log(2)),
    #msm.age2.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(11562,16831), 0.5*log(2)),
    msm.age3.aging.1 = Lognormal.Distribution(log(
        get.aging.rate.last.of.10(91431, 140082)
    ), 0.5 * log(2)),
    ...
    heterosexual.age1.aging.base = Lognormal.Distribution(log((427 + 1861) /
                                                                  2 / (814 + 3752)), 0.25 * log(2)),
    heterosexual.age2.aging.0 = Lognormal.Distribution(log(get.aging.rate.mid.of.20(56552, 151476)), 0.5 *
                                                           log(2)),
    heterosexual.age2.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(49965, 69515)), 0.5 *
                                                           log(2)),
    #heterosexual.age2.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(11562,16831), 0.5*log(2)),
    heterosexual.age3.aging.1 = Lognormal.Distribution(log(
        get.aging.rate.last.of.10(91431, 140082)
    ), 0.5 * log(2)),
    ...
    idu.age1.aging.base = Lognormal.Distribution(log((180 + 221) / 2 / (218 +
                                                                            411)), 0.25 * log(2)),
    idu.age2.aging.0 = Lognormal.Distribution(log(get.aging.rate.mid.of.20(56552, 151476)), 0.5 *
                                                  log(2)),
    idu.age2.aging.1 = Lognormal.Distribution(log(get.aging.rate.last.of.10(49965, 69515)), 0.5 *
                                                  log(2)),
    #idu.age2.aging.2 = Lognormal.Distribution(log(get.aging.rate.last.of.10(11562,16831), 0.5*log(2)),
    idu.age3.aging.1 = Lognormal.Distribution(log(
        get.aging.rate.last.of.10(91431, 140082)
    ), 0.5 * log(2)),
    ...
    male.vs.female.heterosexual.rr = Lognormal.Distribution(log(3.75 / 4.75 * 87.4 /
                                                                    92), 0.5 * log(2)),
    ...
    female.vs.heterosexual.male.idu.susceptibility.rr = Lognormal.Distribution(log(.777 /
                                                                                       .755 * .626 / .585), 0.5 * log(2)),
    ...
    heterosexual.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5 *
                                                                         log(2) / 5),
    msm.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5 * log(2) /
                                                                5),
    idu.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5 * log(2) /
                                                                5),
    msm.idu.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5 *
                                                                    log(2) / 5),
    
    testing.ramp.up.vs.current.rr = Lognormal.Distribution(log(0.5), 0.25 *
                                                               log(2), upper = 1),
    ...
    non.msm.prep.slope.or = Compound.Symmetry.Multivariate.Normal.Distribution(
        rho = 0.8,
        n =
            2,
        mu =
    ...
    prep.persistence = Normal.Distribution(0.56, 0.0587, lower = 0, upper =
                                               1),
    ...
    hispanic.incident.idu.multiplier.0 = Lognormal.Distribution(0, .5 *
                                                                    log(2)),
    ...
    hispanic.incident.idu.multiplier.2 = Lognormal.Distribution(0, .5 *
                                                                    log(2)),
    ...
    hiv.mortality.0 = Lognormal.Distribution(log(9.5 / 6.1 * 23 / 1000), log(2) /
                                                 4),
    hiv.mortality.2 = Lognormal.Distribution(log(23 / 1000), log(2) / 4),
    peak.hiv.mortality = Lognormal.Distribution(log(41 / 6.1 * 23 / 1000), log(2) /
                                                    4),
    ...
    oe.female.pairings.with.msm = Lognormal.Distribution(log(0.0895), 0.5 *
                                                             log(2), upper = 1),
    #Pathela 2006 - see below
    fraction.heterosexual.male.pairings.with.male = Lognormal.Distribution(log(.004), 0.5 *
                                                                               log(2), upper = 1),
    oe.never.idu.pairings.with.idu = Lognormal.Distribution(log(0.2), 0.5 *
                                                                log(2), upper = 1),
    #see calculations below
    
    black.black.sexual.oe = Lognormal.Distribution(log(3.76), 0.25 * log(2), lower =
                                                       1),
    #see below
    hispanic.hispanic.sexual.oe = Lognormal.Distribution(log(2.19), 0.25 *
                                                             log(2), lower = 1),
    other.other.sexual.oe = Lognormal.Distribution(log(1.55), 0.25 * log(2), lower =
                                                       1),
    
    #-- Acute HIV and the Effect of Diagnosis --#
    acute.transmissibility.rr = Lognormal.Distribution(log(12), 0.25 * log(2)),
    #do I have a more evidence based range?
    diagnosed.transmission.rr = Lognormal.Distribution(log(mean(c(
        1 - .68, 1 / 3.5
    ))), 0.25 * log(2), upper = 1),
    #avg of Marks 2006 and Marks 2005
    
    #-- Uncertainty About the Future --#
    msm.fraction.trate.change.after.t2 = Lognormal.Distribution(
        meanlog = log(0.1),
        sdlog = log(2),
        lower = 0,
        upper = 0.5
    ),
    heterosexual.fraction.trate.change.after.t2 = Lognormal.Distribution(
        meanlog = log(0.1),
        sdlog = log(2),
        lower = 0,
        upper = 0.5
    ),
    idu.fraction.trate.change.after.t2 = Lognormal.Distribution(
        meanlog = log(0.1),
        sdlog = log(2),
        lower = 0,
        upper = 0.5
...
get.prep.efficacy.dist <- function(est, lower, upper)
{
    ...
    list(mean = log(rr.est) - sigma ^ 2 / 2,
         sd = sigma)
}
...
BASE.GET.COMPONENTS.FUNCTION <- function(parameters, components,
                                         data.managers = ALL.DATA.MANAGERS)
{
    ...
    components = set.intercept.and.slope.alphas.from.parameters(components,
                                                                ...
                                                                intercept.parameter.suffix='proportion.tested.or',
                                                                slope.parameter.suffix = 'proportion.tested.slope.or',
                                                                idu.applies.to.in.remission=F)

    components = set.background.hiv.testing.ramp.up(components,
                                                    testing.ramp.up.vs.current.rr =
                                                        parameters['testing.ramp.up.vs.current.rr'])
    
    
    #-- PrEP --#
    
    components = setup.prep.susceptibility(
        components,
        prep.rr.heterosexual = exp(
            prep.efficacy.het$mean -
                prep.efficacy.het$sd * parameters['prep.efficacy.z']
        ),
        #higher z is more efficacious
        prep.rr.msm = exp(
            prep.efficacy.msm$mean -
                prep.efficacy.msm$sd * parameters['prep.efficacy.z']
        ),
        #higher z is more efficacious,
        prep.rr.idu = exp(
            prep.efficacy.idu$mean -
                prep.efficacy.idu$sd * parameters['prep.efficacy.z']
        ),
        #higher z is more efficacious,
        prep.persistence = parameters['prep.persistence']
    )
    
    components = set.background.prep.ors(
        components,
        msm.or.intercept = parameters['msm.prep.intercept.or'],
        heterosexual.or.intercept = parameters['non.msm.prep.intercept.or'],
        idu.or.intercept = parameters['non.msm.prep.intercept.or'],
        msm.idu.or.intercept = parameters['msm.prep.intercept.or'],
        
        black.or.intercept = parameters['black.prep.or'],
        hispanic.or.intercept = parameters['hispanic.prep.or'],
        
        age1.or.intercept = parameters['age1.prep.or'],
        age2.or.intercept = parameters['age2.prep.or'],
        age4.or.intercept = parameters['age4.prep.or'],
        age5.or.intercept = parameters['age5.prep.or'],
        
        
        msm.or.slope = parameters['msm.prep.slope.or'],
        heterosexual.or.slope = parameters['heterosexual.prep.slope.or'],
        idu.or.slope = parameters['idu.prep.slope.or'],
        msm.idu.or.slope = parameters['msm.prep.slope.or'],
        
        black.or.slope = parameters['black.prep.or'],
        hispanic.or.slope = parameters['hispanic.prep.or'],
        
        age1.or.slope = parameters['age1.prep.or'],
        age2.or.slope = parameters['age2.prep.or'],
        age4.or.slope = parameters['age4.prep.or'],
        age5.or.slope = parameters['age5.prep.or']
    )
    
    #-- Proportion MSM --#
    
    components = set.proportions.msm.of.male(
        components,
    ...
    components = set.idu.transitions(
        components,
        indices = 1,
    ...
    components = setup.idu.transition.times(
        components,
        years = NA,
        end.year = NA,
        fraction.change.after.last.year =
            parameters['idu.fraction.trate.change.after.t2']
    )
    ...
    components = setup.hiv.mortality.rates(
        components,
    ...
    components = setup.sex.by.sex(
        ...
        fraction.heterosexual.male.pairings.with.male =
            parameters['fraction.heterosexual.male.pairings.with.male']
    )
    
    components = setup.sex.by.idu(
        components,
    ...
    components = setup.transmissibility(
        components,
    ...
    if (any(grepl('total\\.future.*slope\\.or', names(parameters))))
        components = set.future.background.slopes(
            components,
...
EHE.GET.COMPONENTS.FUNCTION = join.get.components.functions(
             ...
             data.managers = ALL.DATA.MANAGERS)
    {
        ...
        components = set.background.suppression.ors(
            components,
            msm.or.intercept = parameters['msm.suppressed.or'],
            heterosexual.or.intercept =
                parameters['heterosexual.suppressed.or'],
            ...
            hispanic.or.intercept =
                parameters['hispanic.suppressed.or'],
            ...
            heterosexual.or.slope =
                parameters['heterosexual.suppressed.slope.or'],
...
VERSION.MANAGER = register.get.components.function(
        VERSION.MANAGER,
        fn = EHE.GET.COMPONENTS.FUNCTION,
        version = 'collapsed_1.0'
)
...
if (1 == 2)
{
    ...
    frac = (206 + .5 * 18) * male.male.partners / ((2511 + 18 * .5) * male.female.partners +
                                                       (206 + 18 * .5) * male.male.partners)
    
    (175300 + .5 * 13700) * male.male.partners / ((1692300 + 13700 * .5) *
                                                      male.female.partners + (175300 + 13700 * .5) * male.male.partners
    )
    ...
    oe.never.idu = frac.never.idu.partner / prev.never.idu
    oe.never.idu
    oe.never.with.idu = frac.last.partner.idu / prevalence.idu.in.sample
    oe.never.with.idu
    ...
    #Race-mixing
    sex.by.race.oes = c(
        ALL.DATA.MANAGERS$pairing$msm.sex.by.race.oe,
        ALL.DATA.MANAGERS$pairing$het.sex.by.race.oe
    )
    ...
    prevalence.msa.2010 = c(idu = 73123 + 46711,
                            msm = 375146,
                            het = 58341 + 130622)
    prevalence.msa.2010 = c(idu = 60739 + 34930,
                            msm = 327677,
                            het = 46095 + 91513)
    ...
    incidence.2010 = c(idu = 1972 + 1097,
                       msm = 23559,
                       het = 3477 + 6651)
    prevalence.2010 = c(idu = 64649 + 40453,
                        msm = 332267,
                        het = 50028 + 112614)
    ...
    inc.by.race = c(black = 18400,
                    hispanic = 9200,
                    white = 10900)
    prev.by.race = c(black = 340290,
                     hispanic = 171228,
                     white = 262009)
    ...
    df = read.csv('../code/calibration/state_rf_level_new_2010_2015.csv',
                  stringsAsFactors = F)
    dim.names = list(
        year = as.character(sort(unique(df$Year))),
    ...
    min.num = msa.surveillance$new.risk['2015', , RISKS] > 10 &
        msa.surveillance$new.risk['2010', , RISKS] > 10
    ...
    est = c(
        ...
        nonaids.black = 1.41,
        aids.hispanic = 1.18,
        nonaids.hispanic = 1.18
    )
    ci.lower = c(
        aids.black = 1.23,
        nonaids.black = 1.26,
        aids.hispanic = 1.05,
        nonaids.hispanic = 1.03
    )
    ci.upper = c(
        aids.black = 1.47,
        nonaids.black = 1.57,
        aids.hispanic = 1.32,
        nonaids.hispanic = 1.36
    )
    ...
    #averages
    log.est.race = c(
        black = log.est['aids.black'] * aids.fraction + log.est['nonaids.black'] * (1 -
                                                                                        aids.fraction),
        hispanic = log.est['aids.hispanic'] * aids.fraction + log.est['nonaids.hispanic'] * (1 -
                                                                                                 aids.fraction)
    )
    names(log.est.race) = c('black', 'hispanic')
    log.var.race = c(
        black = aids.fraction * (log.sd['aids.black'] ^ 2 + log.est['aids.black'] ^
                                     2) +
            (1 - aids.fraction) * (log.sd['nonaids.black'] ^ 2 + log.est['nonaids.black'] ^
                                       2) -
            log.est.race['black'] ^ 2,
        hispanic = aids.fraction * (log.sd['aids.hispanic'] ^
                                        2 + log.est['aids.hispanic'] ^ 2) +
            (1 - aids.fraction) * (log.sd['nonaids.hispanic'] ^
                                       2 + log.est['nonaids.hispanic'] ^ 2) -
