...
parameters.prior = join.distributions(
    ...
    #from table 2 of https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4394837/
    msm.idu.sexual.susceptibiliy.rr = Lognormal.Distribution(log(5.82),log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    idu.transmission = c('female.vs.heterosexual.male.idu.susceptibility.rr',
                         'msm.idu.sexual.susceptibiliy.rr',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    msm.idu.age.rr.peak = msm.age.rr.peak * parameters['msm.idu.sexual.susceptibiliy.rr']
    msm.idu.age.rr0 = msm.age.rr0 * parameters['msm.idu.sexual.susceptibiliy.rr']
    msm.idu.age.rr1 = msm.age.rr1 * parameters['msm.idu.sexual.susceptibiliy.rr']
    msm.idu.age.rr2 = msm.age.rr2 * parameters['msm.idu.sexual.susceptibiliy.rr']
