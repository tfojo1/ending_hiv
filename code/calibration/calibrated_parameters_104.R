#Like v103 with with testing slopes by risk
...
parameters.prior = join.distributions(
    ...
    heterosexual.proportion.tested.slope.or = Lognormal.Distribution(0, log(1.05)),
    msm.proportion.tested.slope.or = Lognormal.Distribution(0, log(1.05)),
    idu.proportion.tested.slope.or = Lognormal.Distribution(0, log(1.05)),
    msm.idu.proportion.tested.slope.or = Lognormal.Distribution(0, log(1.05)),
