...
parameters.prior = join.distributions(
    ...
    heterosexual.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.25)),
    msm.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.25)),
    idu.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.25)),
    msm.idu.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.25)),
    ...
    black.incident.msm.idu.multiplier.0 = Lognormal.Distribution(0, .5*log(2)),
    hispanic.incident.msm.idu.multiplier.0 = Lognormal.Distribution(0, .5*log(2)),
    other.incident.msm.idu.multiplier.0 = Lognormal.Distribution(0, .5*log(2)),
    
    black.incident.msm.idu.multiplier.2 = Lognormal.Distribution(0, .5*log(2)),
    hispanic.incident.msm.idu.multiplier.2 = Lognormal.Distribution(0, .5*log(2)),
    other.incident.msm.idu.multiplier.2 = Lognormal.Distribution(0, .5*log(2)),

    idu.remission.multiplier = Lognormal.Distribution(0, .25*log(2)),
    idu.relapse.multiplier = Lognormal.Distribution(0, .25*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    black.past.idu.transmission = c('black.idu.trate.peak',
                                    'black.idu.trate.0',
                                    'black.incident.idu.multiplier.0',
                                    'black.incident.msm.idu.multiplier.0'),
    
    hispanic.past.idu.transmission = c('hispanic.idu.trate.peak',
                                       'hispanic.idu.trate.0',
                                       'hispanic.incident.idu.multiplier.0',
                                       'hispanic.incident.msm.idu.multiplier.0'),
    
    other.past.idu.transmission = c('other.idu.trate.peak',
                                    'other.idu.trate.0',
                                    'other.incident.idu.multiplier.0',
                                    'other.incident.msm.idu.multiplier.0'),
    
    black.current.idu.transmission = c('black.idu.trate.1',
                                    'black.idu.trate.2',
                                    'black.incident.idu.multiplier.2',
                                    'black.incident.msm.idu.multiplier.2'),
    
    hispanic.current.idu.transmission = c('hispanic.idu.trate.1',
                                       'hispanic.idu.trate.2',
                                       'hispanic.incident.idu.multiplier.2',
                                       'hispanic.incident.msm.idu.multiplier.2'),
    
    other.current.idu.transmission = c('other.idu.trate.1',
                                    'other.idu.trate.2',
                                    'other.incident.idu.multiplier.2',
                                    'other.incident.msm.idu.multiplier.2'),
    ...
    age.susceptibility = c('age1.susceptibility.rr.mult',
    ...
    msm.testing = c('msm.proportion.tested.or',
                    'msm.proportion.tested.slope.or'),
    
    heterosexual.testing = c('heterosexual.proportion.tested.or',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    msm.age.rr1 = c(parameters['age1.msm.susceptibility.rr1'],
                    ...
                    parameters['age4.susceptibility.rr.mult'] * SEXUAL.SUSCEPTIBLITY.RR.BY.AGE[4],
                    parameters['age5.susceptibility.rr.mult'] * SEXUAL.SUSCEPTIBLITY.RR.BY.AGE[5])
    ...
    msm.idu.age.rr.peak = msm.age.rr.peak
    msm.idu.age.rr0 = msm.age.rr0
    msm.idu.age.rr1 = msm.age.rr1
    msm.idu.age.rr2 = msm.age.rr2
    ...
    #-- MSM-IDU Sexual Transmission --#
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='msm.idu', races=race,
                                      age.indices = age.index,
                                      r0 = parameters[paste0(race, '.msm.trate.0')] * msm.idu.age.rr0[age.index],
                                      r1 = parameters[paste0(race, '.msm.trate.1')] * msm.idu.age.rr1[age.index],
                                      r2 = parameters[paste0(race, '.msm.trate.2')] * msm.idu.age.rr2[age.index],
                                      r.peak = parameters[paste0(race, '.msm.trate.peak')] * msm.idu.age.rr.peak[age.index],
                                      fraction.change.after.end = parameters['msm.fraction.trate.change.after.t2'])
        }
    }
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='idu.msm', races=race,
                                      ...
                                      r.peak = parameters[paste0(race, '.idu.trate.peak')] * idu.msm.age.rr.peak[age.index],
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='idu.male', races=race,
                                      ...
                                      r.peak = parameters[paste0(race, '.idu.trate.peak')] * idu.male.age.rr.peak[age.index],
                                      fraction.change.after.end = parameters['idu.fraction.trate.change.after.t2'])
        }
    }
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='idu.female', races=race,
                                      ...
                                      r.peak = parameters[paste0(race, '.idu.trate.peak')] * idu.female.age.rr.peak[age.index],
                                      fraction.change.after.end = parameters['idu.fraction.trate.change.after.t2'])
        }
    }
    ...
    incident.idu.0[,'black',non.msm] = incident.idu.0[,'black',non.msm] * parameters['black.incident.idu.multiplier.0']
    incident.idu.0[,'hispanic',non.msm] = incident.idu.0[,'hispanic',non.msm] * parameters['hispanic.incident.idu.multiplier.0']
    incident.idu.0[,'other',non.msm] = incident.idu.0[,'other',non.msm] * parameters['other.incident.idu.multiplier.0']
    
    incident.idu.2[,'black',non.msm] = incident.idu.2[,'black',non.msm] * parameters['black.incident.idu.multiplier.2']
    incident.idu.2[,'hispanic',non.msm] = incident.idu.2[,'hispanic',non.msm] * parameters['hispanic.incident.idu.multiplier.2']
    incident.idu.2[,'other',non.msm] = incident.idu.2[,'other',non.msm] * parameters['other.incident.idu.multiplier.2']
    
    incident.idu.0[,'black','msm'] = incident.idu.0[,'black','msm'] * parameters['black.incident.msm.idu.multiplier.0']
    incident.idu.0[,'hispanic','msm'] = incident.idu.0[,'hispanic','msm'] * parameters['hispanic.incident.msm.idu.multiplier.0']
    incident.idu.0[,'other','msm'] = incident.idu.0[,'other','msm'] * parameters['other.incident.msm.idu.multiplier.0']
    
    incident.idu.2[,'black','msm'] = incident.idu.2[,'black','msm'] * parameters['black.incident.msm.idu.multiplier.2']
    incident.idu.2[,'hispanic','msm'] = incident.idu.2[,'hispanic','msm'] * parameters['hispanic.incident.msm.idu.multiplier.2']
    incident.idu.2[,'other','msm'] = incident.idu.2[,'other','msm'] * parameters['other.incident.msm.idu.multiplier.2']
