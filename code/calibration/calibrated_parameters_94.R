...
parameters.prior = join.distributions(
    ...
    age1.sexual.susceptibility.rr = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), 0.25*log(2)),
    age2.sexual.susceptibility.rr = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), 0.25*log(2)),
    age4.sexual.susceptibility.rr = Lognormal.Distribution(log(mean(c(63.22,38.29))/mean(c(77.84,63.22))), 0.25*log(2)),
    age5.sexual.susceptibility.rr = Lognormal.Distribution(log(mean(c(38.29,25.03,10.88))/mean(c(77.84,63.22))), 0.25*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    young.age.sexual.susceptibility = c('age1.sexual.susceptibility.rr',
                                        'age2.sexual.susceptibility.rr'),
    
    old.age.sexual.susceptibility = c('age4.sexual.susceptibility.rr',
                                      'age5.sexual.susceptibility.rr'),
    
    young.age.idu.susceptibility = c('age1.idu.susceptibility.rr',
                                     'age2.idu.susceptibility.rr'),
    
    old.age.idu.susceptibility = c('age4.idu.susceptibility.rr',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    # MSM
    msm.age.rr.peak = msm.age.rr0 = c(parameters['age1.sexual.susceptibility.rr'],
                                      parameters['age2.sexual.susceptibility.rr'],
                                      1,
                                      parameters['age4.sexual.susceptibility.rr'],
                                      parameters['age5.sexual.susceptibility.rr']) 
    ...
    heterosexual.male.age.rr.peak = heterosexual.male.age.rr0 =
        ...
        c(parameters['age1.sexual.susceptibility.rr'],
          parameters['age2.sexual.susceptibility.rr'],
          1,
          parameters['age4.sexual.susceptibility.rr'],
          parameters['age5.sexual.susceptibility.rr']) * parameters['male.vs.female.heterosexual.rr']
