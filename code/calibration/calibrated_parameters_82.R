...
parameters.prior = join.distributions(
    ...
    age1.msm.susceptibility.rr1 = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(2)),
    age2.msm.susceptibility.rr1 = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), log(2)),
    age3.msm.susceptibility.rr1 = Lognormal.Distribution(0, log(2)),
    
    age1.msm.susceptibility.rr2 = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(2)),
    age2.msm.susceptibility.rr2 = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), log(2)),
    age3.msm.susceptibility.rr2 = Lognormal.Distribution(0, log(2)),
    ...
    age1.msm.susceptibility.rr0 = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(2)),
    age2.msm.susceptibility.rr0 = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), log(2)),
    age4.msm.susceptibility.rr = Lognormal.Distribution(log(mean(c(63.22,38.29))/mean(c(77.84,63.22))), log(2)),
    age5.msm.susceptibility.rr = Lognormal.Distribution(log(mean(c(38.29,25.03,10.88))/mean(c(77.84,63.22))), log(2)),
    
    age1.heterosexual.male.susceptibility.rr = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(2)),
    age2.heterosexual.male.susceptibility.rr = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), log(2)),
    age4.heterosexual.male.susceptibility.rr = Lognormal.Distribution(log(mean(c(63.22,38.29))/mean(c(77.84,63.22))), log(2)),
    age5.heterosexual.male.susceptibility.rr = Lognormal.Distribution(log(mean(c(38.29,25.03,10.88))/mean(c(77.84,63.22))), log(2)),
    
    age1.heterosexual.female.susceptibility.rr = Lognormal.Distribution(log(0.6*78.50/mean(c(77.84,63.22))), log(2)),
    age2.heterosexual.female.susceptibility.rr = Lognormal.Distribution(log(mean(c(78.50,77.84))/mean(c(77.84,63.22))), log(2)),
    age4.heterosexual.female.susceptibility.rr = Lognormal.Distribution(log(mean(c(63.22,38.29))/mean(c(77.84,63.22))), log(2)),
    age5.heterosexual.female.susceptibility.rr = Lognormal.Distribution(log(mean(c(38.29,25.03,10.88))/mean(c(77.84,63.22))), log(2)),
    ...
    age1.idu.susceptibility.rr = Lognormal.Distribution(log(.762/.788*.720/.672), log(2)),
    age2.idu.susceptibility.rr = Lognormal.Distribution(log(.797/.788*.705/.672), log(2)),
    age4.idu.susceptibility.rr = Lognormal.Distribution(log(.745/.788*.596/.672), log(2)),
    age5.idu.susceptibility.rr = Lognormal.Distribution(log(.740/.788*.498/.672), log(2)),
    ...
    msm.age4.aging.2 = Lognormal.Distribution(log(0.1), 0.25*log(2)),
    ...
    heterosexual.age4.aging.2 = Lognormal.Distribution(log(0.1), 0.25*log(2)),
    ...
    idu.age4.aging.2 = Lognormal.Distribution(log(0.1), 0.25*log(2)),
