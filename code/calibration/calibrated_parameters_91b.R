                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    # IDU - MSM
    idu.msm.age.rr.peak = idu.male.age.rr.peak * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr']
    idu.msm.age.rr0 = idu.male.age.rr0 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr']
    idu.msm.age.rr1 = idu.male.age.rr1 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr']
    idu.msm.age.rr2 = idu.male.age.rr2 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr']
