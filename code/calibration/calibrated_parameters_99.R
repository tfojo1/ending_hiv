...
parameters.prior = join.distributions(
    ...
    black.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
    hispanic.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
    
    age1.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
    age2.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
    age4.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
    age5.proportion.tested.slope.or = Lognormal.Distribution(0, 0.5*log(1.05)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    black.msm.idu.past.transmission = c('black.msm.idu.trate.peak',
                                        'black.msm.idu.trate.0'),
    
    hispanic.msm.idu.past.transmission = c('hispanic.msm.idu.trate.peak',
                                           'hispanic.msm.idu.trate.0'),
    
    other.msm.idu.past.transmission = c('other.msm.idu.trate.peak',
                                        'other.msm.idu.trate.0'),
    
    msm.idu.transmission.1 = c('black.msm.idu.trate.1',
                               'hispanic.msm.idu.trate.1',
                               'other.msm.idu.trate.1'),
    
    msm.idu.transmission.2 = c('black.msm.idu.trate.2',
                               'hispanic.msm.idu.trate.2',
                               'other.msm.idu.trate.2'),
    ...
    msm.heterosexual.suppression = c('msm.suppressed.or',
    ...
    black.hispanic.suppression = c('black.suppressed.or',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    # IDU - MSM
    idu.msm.age.rr.peak = idu.male.age.rr.peak
    idu.msm.age.rr0 = idu.male.age.rr0
    idu.msm.age.rr1 = idu.male.age.rr1
    idu.msm.age.rr2 = idu.male.age.rr2
    ...
    for (age.index in 1:5)
    {
        for (race in c('black','hispanic','other'))
        {
            components = setup.trates(components, routes='idu.msm', races=race,
                                      age.indices = age.index,
                                      r0 = parameters[paste0(race, '.msm.idu.trate.0')] * idu.msm.age.rr0[age.index],
                                      r1 = parameters[paste0(race, '.msm.idu.trate.1')] * idu.msm.age.rr1[age.index],
                                      r2 = parameters[paste0(race, '.msm.idu.trate.2')] * idu.msm.age.rr2[age.index],
                                      r.peak = parameters[paste0(race, '.msm.idu.trate.peak')] * idu.msm.age.rr.peak[age.index],
    ...
    components = set.background.hiv.testing.ors(components,
                                                ...
                                                black.or.slope=parameters['black.proportion.tested.slope.or'],
                                                hispanic.or.slope=parameters['hispanic.proportion.tested.slope.or'],
                                                age1.or.slope=parameters['age1.proportion.tested.slope.or'],
                                                age2.or.slope=parameters['age2.proportion.tested.slope.or'],
                                                age4.or.slope=parameters['age4.proportion.tested.slope.or'],
                                                age5.or.slope=parameters['age5.proportion.tested.slope.or'])
