#Like v103 but with idu risk varying by female and msm x time
...
parameters.prior = join.distributions(
    ...
    #-- Other IDU Transmission Parameters --#
    ...
    msm.idu.suppressed.or = Lognormal.Distribution(0, 0.5*log(2)),
...
PARAMETER.VAR.BLOCKS.1 = list(
    ...
    idu.susceptibility = c('msm.vs.heterosexual.male.idu.susceptibility.rr.peak',
                                                     ...
                                                     data.managers = ALL.DATA.MANAGERS)
{
    ...
    idu.female.age.rr.peak = idu.age.rr.peak * parameters['female.vs.heterosexual.male.idu.susceptibility.rr']
    idu.female.age.rr0 = idu.age.rr0 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr']
    idu.female.age.rr1 = idu.age.rr1 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr']
    idu.female.age.rr2 = idu.age.rr2 * parameters['female.vs.heterosexual.male.idu.susceptibility.rr']
    
    idu.msm.age.rr.peak = idu.age.rr.peak * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr.peak']
    idu.msm.age.rr0 = idu.age.rr0 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr.0']
    idu.msm.age.rr1 = idu.age.rr1 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr.1']
    idu.msm.age.rr2 = idu.age.rr2 * parameters['msm.vs.heterosexual.male.idu.susceptibility.rr.2']
