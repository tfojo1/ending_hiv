...
YBHMSM.R80 = join.interventions(YBHMSM.RS80, YBHMSM.RF80, YBHMSM.RN80)
...
YBHMSM.R90 = join.interventions(YBHMSM.RS90, YBHMSM.RF90, YBHMSM.RN90)
...
YBHMSM.R95 = join.interventions(YBHMSM.RS95, YBHMSM.RF95, YBHMSM.RN95)
...
MSMIDU.R80 = join.interventions(MSMIDU.RS80, MSMIDU.RF80, MSMIDU.RN80)
...
MSMIDU.R90 = join.interventions(MSMIDU.RS90, MSMIDU.RF90, MSMIDU.RN90)
...
MSMIDU.R95 = join.interventions(MSMIDU.RS95, MSMIDU.RF95, MSMIDU.RN95)
...
WHOLEPOP.R80 = join.interventions(WHOLEPOP.RS80, WHOLEPOP.RF80, WHOLEPOP.RN80)
...
WHOLEPOP.R90 = join.interventions(WHOLEPOP.RS90, WHOLEPOP.RF90, WHOLEPOP.RN90)
...
WHOLEPOP.R95 = join.interventions(WHOLEPOP.RS95, WHOLEPOP.RF95, WHOLEPOP.RN95)
