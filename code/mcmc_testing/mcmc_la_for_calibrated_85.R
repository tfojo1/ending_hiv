...
source('code/calibration/calibrated_parameters_85.R')
...
FILE.PREFIX = 'la.85_supp.wt.1_2010.anchor'
DESCRIPTION = "V85"
...
init.parameters = c(
    ...
    heterosexual.male.age1.aging.base = 0.167,
    heterosexual.male.age2.aging.0 = 0.258,
    heterosexual.male.age2.aging.1 = 0.098,
    heterosexual.male.age3.aging.1 = 0.103,
    heterosexual.male.age3.aging.2 = 0.100,
    heterosexual.male.age4.aging.1 = 0.041,
    heterosexual.male.age4.aging.2 = 0.101,
    
    heterosexual.female.age1.aging.base = 0.167,
    heterosexual.female.age2.aging.0 = 0.258,
    heterosexual.female.age2.aging.1 = 0.098,
    heterosexual.female.age3.aging.1 = 0.103,
    heterosexual.female.age3.aging.2 = 0.100,
    heterosexual.female.age4.aging.1 = 0.041,
    heterosexual.female.age4.aging.2 = 0.101,
    ...
    #-- Other Sexual Transmission Parameters --#
    male.vs.female.heterosexual.rr.peak = 0.405,
    male.vs.female.heterosexual.rr0 = 0.405,
    male.vs.female.heterosexual.rr1 = 0.405,
    male.vs.female.heterosexual.rr2 = 0.405,
    
    female.vs.heterosexual.male.idu.susceptibility.rr = 1,
    msm.vs.heterosexual.male.idu.susceptibility.rr = 1,
    
    #-- HIV Testing --#
    heterosexual.proportion.tested.or = 0.794 / .611^10,
    msm.proportion.tested.or = 0.268 / .611^10,
    idu.proportion.tested.or = 0.843 / .611^10,
    ...
    #-- Suppression --#
    heterosexual.suppressed.or = 1.798 / 1.005^10,
    msm.suppressed.or = 1.044 / 1.001^10,
    idu.suppressed.or = 1.162 / .996^10,
    
    black.suppressed.or = 0.703 / .975^10,
    hispanic.suppressed.or = 0.747 / .937^10,
    
    age1.suppressed.or = 0.604 / 1.009^10,
    age2.suppressed.or = 1.437 / 1.000^10,
    age4.suppressed.or = 0.804 / .984^10,
    age5.suppressed.or = 1.437 / 1.004^10,
