...
source('code/calibration/calibrated_parameters_92.R')
...
FILE.PREFIX = 'la.92_supp.wt.1.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1'
DESCRIPTION = "V92"
...
init.parameters = c(
    ...
    age1.susceptibility.rr = 0.900,
    age2.susceptibility.rr = 1.177,
    age4.susceptibility.rr = 0.441,
    age5.susceptibility.rr = 0.157,
    ...
    msm.vs.heterosexual.male.idu.susceptibility.rr = 6.725,
