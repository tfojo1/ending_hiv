...
source('code/calibration/calibrated_parameters_93b.R')
...
FILE.PREFIX = 'la.93b_supp.wt.1.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1'
DESCRIPTION = "V93b"
...
init.parameters = c(
    ...
    msm.idu.sexual.susceptibiliy.rr = 1,
