...
source('code/calibration/calibrated_parameters_104.R')
...
init.parameters = c(
    ...
    heterosexual.proportion.tested.slope.or = 0.912,
    msm.proportion.tested.slope.or = 0.912,
    idu.proportion.tested.slope.or = 0.912,
    msm.idu.proportion.tested.slope.or = 0.912,
