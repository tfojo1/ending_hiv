...
source('code/calibration/calibrated_parameters_106.R')
...
FILE.PREFIX = 'la.106_revised.lik'
DESCRIPTION = "V106; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 0.25; supp wt 0.25; focus wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.106_revised.lik_20K_2020-09-15/'
