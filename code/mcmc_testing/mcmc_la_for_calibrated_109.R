...
source('code/calibration/calibrated_parameters_109.R')
...
FILE.PREFIX = 'la.109_revised.lik.v2'
DESCRIPTION = "V109; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 0.25; supp wt 0.25; focus wt 1; aids dx wt 1"
