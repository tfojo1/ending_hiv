...
source('code/calibration/calibrated_parameters_93.R')
...
FILE.PREFIX = 'la.93_supp.wt.1.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1'
DESCRIPTION = "V93"
