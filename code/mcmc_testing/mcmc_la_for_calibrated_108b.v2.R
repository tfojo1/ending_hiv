...
FILE.PREFIX = 'la.108b_revised.lik.v10'
DESCRIPTION = "V108b; prev cv 0.034 with CV only with ratio wt 2; new cv 0.065 with cv only; dx wt 0.5 with no strat; testing likelihood with total wt 0.0625, strat wt 0.5; supp wt 0.25; focus wt 1; aids dx wt 1"
RESUME.PRIOR.CACHE = NULL#fil.'mcmc_runs/test_caches/la.108b_revised.lik.v10_20K_2020-09-18/'
