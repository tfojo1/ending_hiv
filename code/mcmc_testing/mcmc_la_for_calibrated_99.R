...
source('code/calibration/calibrated_parameters_99.R')
...
FILE.PREFIX = 'la.99_new.065cv.wt.5_prev.034cv.wt.125_idu.wt.1_focus.wt.1'
DESCRIPTION = "V99"
...
init.parameters = c(
    ...
    black.proportion.tested.slope.or = 0.936,
    hispanic.proportion.tested.slope.or = 0.936,
    
    age1.proportion.tested.slope.or = 0.936,
    age2.proportion.tested.slope.or = 0.936,
    age4.proportion.tested.slope.or = 0.936,
    age5.proportion.tested.slope.or = 0.936,
