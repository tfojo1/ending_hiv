...
source('code/calibration/calibrated_parameters_105.R')
...
init.parameters = c(
    ...
    msm.vs.heterosexual.male.idu.susceptibility.rr.peak = 1,
    msm.vs.heterosexual.male.idu.susceptibility.rr.0 = 1,
    msm.vs.heterosexual.male.idu.susceptibility.rr.1 = 1,
    msm.vs.heterosexual.male.idu.susceptibility.rr.2 = 1,
    
    #-- HIV Testing --#
    heterosexual.proportion.tested.or = 0.794,
    msm.proportion.tested.or = 0.268,
    idu.proportion.tested.or = 0.843,
    msm.idu.proportion.tested.or = 0.268 * 0.843,
    ...
    msm.idu.suppressed.or = 1.044 * 1.162,
    ...
    msm.idu.suppressed.slope.or = 1.001 * 0.996,
