...
source('code/calibration/calibrated_parameters_113c.R')
...
FILE.PREFIX = 'la.113c_revised.lik.v12'
DESCRIPTION = "V113c; prev cv 0.034 with CV only with ratio wt 2; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with total wt inv32 strat wt 0.5; supp wt 0.25; focus wt 1; aids dx wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.113c_revised.lik.v12_20K_2020-09-20/'
