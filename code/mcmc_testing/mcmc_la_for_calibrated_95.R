...
FILE.PREFIX = 'la.95_supp.wt.1.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1_idu.wt.32'
DESCRIPTION = "V95"
RESUME.PRIOR.CACHE = 'mcmc_runs/test_caches/la.95_supp.wt.1.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1_idu.wt.32_20K_2020-09-03/'
