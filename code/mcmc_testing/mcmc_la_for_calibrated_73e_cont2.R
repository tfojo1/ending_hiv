...
FILE.PREFIX = 'la.73e_8_all.with.prev.ratio_revised.cont'
DESCRIPTION = "V73e; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 1; supp wt 0.25; focus wt 1; testing prior is national data only"
...
init.parameters = c(
    ...
    #-- HIV Testing --#
    heterosexual.proportion.tested.or = 0.794 * 0.2837,
    msm.proportion.tested.or = 0.268 * 0.2837,
    idu.proportion.tested.or = 0.843 * 0.2837,
    ...
    total.proportion.tested.slope.or = 0.912 * 0.9485,
