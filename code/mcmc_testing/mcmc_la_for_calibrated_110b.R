...
source('code/calibration/calibrated_parameters_110b.R')
...
FILE.PREFIX = 'la.110b_revised.lik.v9_test.anchor.2010'
DESCRIPTION = "V110b; prev cv 0.034 with CV only with ratio with wt 4; new cv 0.065 with cv only; dx wt 1 with no strat; testing total wt 1, strat 0.125; supp wt 0.25; focus wt 1; aids dx wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.110_revised.lik.v3_20K_2020-09-16/'
