...
source('code/calibration/calibrated_parameters_107.R')
...
FILE.PREFIX = 'la.107_revised.lik'
DESCRIPTION = "V107; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 0.25; supp wt 0.25; focus wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.107_revised.lik_20K_2020-09-15/'
...
init.parameters = c(
    ...
    #-- IDU Transmission --#
    black.msm.idu.trate.peak = 6.638 * 2.484,
    black.msm.idu.trate.0 = 2.623 * 6.688,
    black.msm.idu.trate.1 = 4.347 * 3.200,
    black.msm.idu.trate.2 = 4.014 * 3.463,
    
    hispanic.msm.idu.trate.peak = 2.523 * 2.484,
    hispanic.msm.idu.trate.0 = 0.958 * 6.688,
    hispanic.msm.idu.trate.1 = 1.451 * 3.200,
    hispanic.msm.idu.trate.2 = 1.657 * 3.463,
    
    other.msm.idu.trate.peak = 2.150 * 6.688,
    other.msm.idu.trate.0 = 1.212 * 6.688,
    other.msm.idu.trate.1 = 1.838 * 3.200,
    other.msm.idu.trate.2 = 1.402 * 3.463,
