...
source('code/calibration/calibrated_parameters_112.R')
...
FILE.PREFIX = 'la.112_revised.lik.v4'
DESCRIPTION = "V112; prev cv 0.034 with CV only with ratio with wt 1; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with total wt NA strat wt 1; supp wt 0.25; focus wt 1; aids dx wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.112_revised.lik.v4_20K_2020-09-16/'
...
init.parameters = c(
    ...
    #-- MSM Transmission --#
    black.msm.trate.peak = 9.858,
    black.msm.trate.0 = 0.999,
    black.msm.trate.1 = 2.399 * 0.703,
    black.msm.trate.2 = 2.102 * 0.618,
    
    hispanic.msm.trate.peak = 1.181,
    hispanic.msm.trate.0 = 1.210,
    hispanic.msm.trate.1 = 0.962 * 0.703,
    hispanic.msm.trate.2 = 1.150 * 0.618,
    
    other.msm.trate.peak = 0.686,
    ...
    #-- Other Sexual Transmission Parameters --#
    male.vs.female.heterosexual.rr.peak = 0.484,
    male.vs.female.heterosexual.rr.0 = 0.484,
    male.vs.female.heterosexual.rr.1 = 0.484,
    male.vs.female.heterosexual.rr.2 = 0.484,
    
    female.vs.heterosexual.male.idu.susceptibility.rr.peak = 0.886,
    female.vs.heterosexual.male.idu.susceptibility.rr.0 = 0.886,
    female.vs.heterosexual.male.idu.susceptibility.rr.1 = 0.886,
    female.vs.heterosexual.male.idu.susceptibility.rr.2 = 0.886,
...
if (!is.null(RESUME.PRIOR.CACHE))
{
    ...
    DESCRIPTION = paste0('resumed prior', DESCRIPTION)
