...
source('code/calibration/calibrated_parameters_95.R')
...
FILE.PREFIX = 'la.95v2_supp.wt.125.decreasing.stratified_new.047cv.only_prev.058cv.only_prev.wt.25.no.cv.scaling_dx.wt.1_idu.wt.2'
DESCRIPTION = "V95"
...
init.parameters = c(
    ...
    age1.sexual.susceptibility.rr = 0.883,
    age2.sexual.susceptibility.rr = 1.153,
    age4.sexual.susceptibility.rr = 0.652,
    age5.sexual.susceptibility.rr = 0.156,
    
    age1.idu.susceptibility.rr = 1.168,
    age2.idu.susceptibility.rr = 0.990,
    age4.idu.susceptibility.rr = 0.755,
    age5.idu.susceptibility.rr = 0.745,
