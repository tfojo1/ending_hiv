...
init.parameters = c(
    ...
    #-- HIV Testing --#
    heterosexual.proportion.tested.or = .259,
    msm.proportion.tested.or =.324,
    idu.proportion.tested.or = .375,
    
    total.testing.slope.or = .896,

    age1.msm.testing.or = .746,
    age2.msm.testing.or = .860,
    
    testing.ramp.up.vs.current.rr = .296,
    ...
    #-- Suppression --#
    total.suppressed.or = 1.08,
    
    age1.msm.suppressed.or.slope = .929,
    age2.msm.suppressed.or.slope = 1.41,
