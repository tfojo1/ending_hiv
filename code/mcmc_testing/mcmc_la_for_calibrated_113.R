...
source('code/calibration/calibrated_parameters_113.R')
...
FILE.PREFIX = 'la.113_revised.lik.v10'
DESCRIPTION = "V113; prev cv 0.034 with CV only with ratio wt 2; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with total wt NA strat wt 0.5; supp wt 0.25; focus wt 1; aids dx wt 1"
RESUME.PRIOR.CACHE = NULL#'mcmc_runs/test_caches/la.113_revised.lik.v10_20K_2020-09-18/'
