...
source('code/calibration/calibrated_parameters_98.R')
...
FILE.PREFIX = 'la.98b_revised.lik'
DESCRIPTION = "V98; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 1; supp wt 0.25; focus wt 1"
...
init.parameters = c(
    ...
    age1.susceptibility.rr.mult = 0.900 / 0.667,
    age2.susceptibility.rr.mult = 1.177 / 1.108,
    age4.susceptibility.rr.mult = 0.441 / 0.720,
    age5.susceptibility.rr.mult = 0.157 / 0.350,
