...
source('../code/calibration/calibrated_parameters_64.R')
...
THIN = 25
CACHE.FREQUENCY = 500
FILE.PREFIX = 'dc64.3_focus.wt.9_all.x3_prev.x4.6'
DESCRIPTION = "V64: half mult error sd, half exp error sd; all x3 + prev x2.6"
...
likelihood.parameters = list(PREV.SD=PREV.SD,
                             ...
                             MORT.SD=MORT.SD,
                             DX.SD=DX.SD,
                             SD.INFLATION.NEW.NUM=SD.INFLATION.NEW,
                             SD.INFLATION.PREV.NUM=SD.INFLATION.PREV,
...
init.parameters = c(
    ...
    age1.susceptibility.rr1 = 0.767,
    age2.susceptibility.rr1 = 1.265,
    age4.susceptibility.rr1 = 0.645,
    age5.susceptibility.rr1 = 0.248,

    age1.susceptibility.rr2 = 0.767,
    age2.susceptibility.rr2 = 1.265,
    age4.susceptibility.rr2 = 0.645,
    age5.susceptibility.rr2 = 0.248,
