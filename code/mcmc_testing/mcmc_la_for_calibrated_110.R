...
source('code/calibration/calibrated_parameters_110.R')
...
FILE.PREFIX = 'la.110_revised.lik.v9'
DESCRIPTION = "V110; prev cv 0.034 with CV only with ratio with wt 4; new cv 0.065 with cv only; dx wt 1 with no strat; testing total wt 1, strat 0.125; supp wt 0.25; focus wt 1; aids dx wt 1"
