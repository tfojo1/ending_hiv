...
source('code/calibration/calibrated_parameters_88.R')
...
init.parameters = c(
    ...
    age1.heterosexual.male.susceptibility.rr1 = 0.997,
    age2.heterosexual.male.susceptibility.rr1 = 1.185,
    age3.heterosexual.male.susceptibility.rr1 = 1,
    age4.heterosexual.male.susceptibility.rr1 = 0.737,
    age5.heterosexual.male.susceptibility.rr1 = 0.150,
    
    age1.heterosexual.female.susceptibility.rr1 = 0.997,
    age2.heterosexual.female.susceptibility.rr1 = 1.185,
    age3.heterosexual.female.susceptibility.rr1 = 1,
    age4.heterosexual.female.susceptibility.rr1 = 0.737,
    age5.heterosexual.female.susceptibility.rr1 = 0.150,
    
    age1.idu.susceptibility.rr1 = 0.997,
    age2.idu.susceptibility.rr1 = 1.185,
    age3.idu.susceptibility.rr1 = 1,
    age4.idu.susceptibility.rr1 = 0.737,
    age5.idu.susceptibility.rr1 = 0.150,
