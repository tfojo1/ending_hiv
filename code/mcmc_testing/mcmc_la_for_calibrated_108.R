...
source('code/calibration/calibrated_parameters_108.R')
...
FILE.PREFIX = 'la.108_revised.lik.v2'
DESCRIPTION = "V108; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 0.5 with no strat; testing likelihood with wt 1; supp wt 0.25; focus wt 1; aids dx wt 1"
