...
source('code/calibration/calibrated_parameters_79.R')
...
init.parameters = c(
    ...
    age3.msm.susceptibility.rr = 0.605,
    ...
    age3.heterosexual.male.susceptibility.rr = 1*.41,
    ...
    age3.heterosexual.female.susceptibility.rr = 1,
