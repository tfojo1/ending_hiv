...
FILE.PREFIX = 'la.100b_revised.lik'
DESCRIPTION = "V100b; prev cv 0.034 with CV only with ratio; new cv 0.065 with cv only; dx wt 1 with no strat; testing likelihood with wt 1; supp wt 0.25; focus wt 1"
