...
#Load up the mcmc
load('mcmc_runs/systematic_initial/31080_1x20K_2020-07-21.Rdata')
...
pp2 = pp1
pp2['total.suppressed.slope.or'] = 0.94
...
exp(supp.lik.uninflated(sim2)-supp.lik.uninflated(sim1))
...
supp.lik.uninflated = supp.lik.all = create.suppressed.likelihood(location=msa,
                                                             years=suppression.years,
                                                             surv=msa.surveillance,
                                                             numerator.year.to.year.chunk.correlation=0.5,
                                                             numerator.chunk.years=list(suppression.years),
