...
RETENTION.NAIVE.80 = create.intervention.unit(type = "naive.to.disengaged", rates = 1-0.8, start.year = 2023, years = 2027, scale="proportion")
RETENTION.DURABLE.80 = create.intervention.unit(type = "durably.suppressed.to.disengaged", rates = 1-0.8, start.year = 2023, years = 2027, scale="proportion")
RETENTION.RECENT.80 = create.intervention.unit(type = "recently.suppressed.to.disengaged", rates = 1-0.8, start.year = 2023, years = 2027, scale="proportion")
RETENTION.FAILING.80 = create.intervention.unit(type = "failing.to.disengaged", rates = 1-0.8, start.year = 2023, years = 2027, scale="proportion")
...
RETENTION.NAIVE.90 = create.intervention.unit(type = "naive.to.disengaged", rates = 1-0.9, start.year = 2023, years = 2027, scale="proportion")
RETENTION.DURABLE.90 = create.intervention.unit(type = "durably.suppressed.to.disengaged", rates = 1-0.9, start.year = 2023, years = 2027, scale="proportion")
RETENTION.RECENT.90 = create.intervention.unit(type = "recently.suppressed.to.disengaged", rates = 1-0.9, start.year = 2023, years = 2027, scale="proportion")
RETENTION.FAILING.90 = create.intervention.unit(type = "failing.to.disengaged", rates = 1-0.9, start.year = 2023, years = 2027, scale="proportion")
...
RETENTION.NAIVE.95 = create.intervention.unit(type = "naive.to.disengaged", rates = 1-0.95, start.year = 2023, years = 2027, scale="proportion")
RETENTION.DURABLE.95 = create.intervention.unit(type = "durably.suppressed.to.disengaged", rates = 1-0.95, start.year = 2023, years = 2027, scale="proportion")
RETENTION.RECENT.95 = create.intervention.unit(type = "recently.suppressed.to.disengaged", rates = 1-0.95, start.year = 2023, years = 2027, scale="proportion")
RETENTION.FAILING.95 = create.intervention.unit(type = "failing.to.disengaged", rates = 1-0.95, start.year = 2023, years = 2027, scale="proportion")
