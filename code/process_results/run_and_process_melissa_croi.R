...
# Fig 1 - Within MSA, PrEP vs. Suppression
...
msa <- c("LA","NYC","Atlanta","Baltimore")
...
improve$forColor <-
  factor(c(rep("PrEP, all MSM",4),rep("Supp, all MSM",4),rep("PrEP, young MSM",4),rep("Supp, young MSM",4)),
         levels = c("PrEP, all MSM","Supp, all MSM","PrEP, young MSM","Supp, young MSM"))
