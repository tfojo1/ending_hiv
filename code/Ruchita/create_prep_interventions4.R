...
#                                                 max.rate = 1)
    ...
    BASELINE.TO.INJ.EFFICACY = create.intervention.unit(type='rr.lai.prep', start.year=2000,
                                                 rates=expression(oral.prep.rr * inj.vs.oral.hr),
                                                 years=2000.001,
                                                 allow.less.than.otherwise = T)
    
    # converting baseline oral to inj
    
    BASELINE.TO.INJ.EFFICACY = create.intervention.unit(type='rr.prep', 
