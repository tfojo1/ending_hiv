                                         ...
                                         INTERVENTION.MANAGER = INTERVENTION.MANAGER.1.0)
{
    ...
    PREP.PLUS.10.INJ = create.intervention.unit(type='lai.prep', start.year=start.year,
    ...
    INJ.PREP.EFFICACY = create.intervention.unit(type='rr.lai.prep', start.year=2000,
                                                 rates=expression(oral.prep.rr * inj.vs.oral.hr),
                                                 years=2000.001,
                                                 allow.less.than.otherwise = T)
    
    CONVERT.ORAL.TO.INJ.EFFICACY = create.intervention.unit(type='rr.prep', start.year=2000,
                                                            rates=expression(oral.prep.rr * inj.vs.oral.hr),
                                                            years=2000.001,
                                                            allow.less.than.otherwise = T)
