...
server <- function(input, output, session) {
  ...
  # TODO @jef: Is this for sensitivity analysis? If so, i think i can iteratively 
  # delete parts of this section and check that it works until all removed.
  # sens ----------------------------------------------------------------- ####
  ...
  # Observe ####
  observe({
    res_sens()  # jef: What's this func do?
